        ...
        <div className="max-w-5xl w-full mb-16">
          <div className="mb-12 text-center flex flex-col items-center">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-foreground leading-tight text-center">
              Coloque sua barbearia no automático em <br className="hidden md:block" />menos de <span className="text-primary italic">5 minutos</span>
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl text-center">
              ...
              Crie sua conta, personalize seu perfil e comece a receber agendamentos online hoje mesmo.
            </p>
          </div>
